...
def build_xml_request(phone_number, amount):
    ...
    content_template = '''Witaj w systemie powiadomień, proszę o uregulowanie płatności
serwis: Youtube Premium
status: odnowiona do 17.02.2024r
zaległa należność: {}zł

Proszę, nie odpowiadaj na ten SMS'''
...
if __name__ == "__main__":
    ...
    for phone_number, amount in phone_amount_mapping.items():
        time.sleep(20); #timeout before sending another SMS
